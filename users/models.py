...
class User(AbstractUser):
    ...
    phone = models.CharField(
        max_length=30, verbose_name="Контактный телефон", **NULLABLE
    )
...
class Payment(models.Model):
    ...
    paid_lesson = models.ForeignKey(
        Lesson, verbose_name="урок", on_delete=models.CASCADE, **NULLABLE
    )
    ...
    def __str__(self):
        return (
            f"Студент: {self.user} оплатил: {self.paid_course if self.paid_course else self.paid_lesson}, "
